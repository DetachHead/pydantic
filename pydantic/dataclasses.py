...
# due to https://github.com/python/mypy/pull/10712, both conditions require a "fake" implementation, where the real
#  implementation is hidden from mypy when not TYPE_CHECKING.
if TYPE_CHECKING:
    if sys.version_info >= (3, 10):
